    ...
    <>
      <header className="ps-header ps-header--1">
        ...
        <div className="ps-header__middle">
          <div className="container">
            <div className="ps-logo"><a href="index-2.html"> <img src="img/logo.png" alt=""/><img
              className="sticky-logo" src="img/sticky-logo.png" alt=""/></a></div>
            <a className="ps-menu--sticky" href="#"><i className="fa fa-bars"/></a>
            <div className="ps-header__right">
              <ul className="ps-header__icons">
                <li><a className="ps-header__item open-search" href="#"><i className="icon-magnifier"/></a></li>
                <li><a className="ps-header__item" href="#" id="login-modal"><i className="icon-user"/></a>
                ...
                <li><a className="ps-header__item" href="wishlist.html"><i className="fa fa-heart-o"/><span
                  className="badge">3</span></a></li>
                <li><a className="ps-header__item" href="#" id="cart-mini"><i className="icon-cart-empty"/><span
                  className="badge">2</span></a>
                  <div className="ps-cart--mini">
                    <ul className="ps-cart__items">
                      <li className="ps-cart__item">
                        <div className="ps-product--mini-cart"><a className="ps-product__thumbnail"
                                                                  href="product-default.html"><img
                          src="img/products/055.jpg" alt="alt"/></a>
                          <div className="ps-product__content"><a className="ps-product__name"
                                                                  href="product-default.html">Somersung Sonic X2500
                            Pro White</a>
                            <p className="ps-product__meta"><span className="ps-product__price">$399.99</span></p>
                          </div>
                          <a className="ps-product__remove" href="javascript: void(0)"><i className="icon-cross"/></a>
                        </div>
                      </li>
                      <li className="ps-cart__item">
                        <div className="ps-product--mini-cart"><a className="ps-product__thumbnail"
                                                                  href="product-default.html"><img
                          src="img/products/001.jpg" alt="alt"/></a>
                          <div className="ps-product__content"><a className="ps-product__name"
                                                                  href="product-default.html">Digital Thermometer
                            X30-Pro</a>
                            <p className="ps-product__meta"><span className="ps-product__sale">$77.65</span><span
                              className="ps-product__is-price">$80.65</span></p>
                          </div>
                          <a className="ps-product__remove" href="javascript: void(0)"><i className="icon-cross"/></a>
                        </div>
                      </li>
                    ...
                    <div className="ps-cart__footer"><a className="ps-btn ps-btn--outline" href="shopping-cart.html">View
                      Cart</a><a className="ps-btn ps-btn--warning" href="checkout.html">Checkout</a></div>
                  </div>
                </li>
              </ul>
              <div className="ps-language-currency"><a className="ps-dropdown-value" href="javascript:void(0);"
                                                       data-toggle="modal" data-target="#popupLanguage">English</a><a
                className="ps-dropdown-value" href="javascript:void(0);" data-toggle="modal"
                data-target="#popupCurrency">USD</a></div>
                    ...
                    <div className="row m-0">
                      <div className="col-12 col-lg-6">
                        <div className="ps-product ps-product--horizontal">
                          ...
                          <div className="ps-product__content">
                            <h5 className="ps-product__title"><a>3-layer <span className="hightlight">mask</span> with
                              an elastic band (1 piece)</a></h5>
                            <p className="ps-product__desc">Study history up to 30 days Up to 5 users simultaneously
                              Has HEALTH certificate</p>
                        ...
                        <div className="ps-product ps-product--horizontal">
                          ...
                          <div className="ps-product__content">
                            ...
                            <div className="ps-product__meta"><span
                              className="ps-product__price sale">$14.52</span><span
                        ...
                        <div className="ps-product ps-product--horizontal">
                          ...
                          <div className="ps-product__content">
                            ...
                            <p className="ps-product__desc">Study history up to 30 days Up to 5 users simultaneously
                              Has HEALTH certificate</p>
                            <div className="ps-product__meta"><span
                              className="ps-product__price sale">$14.99</span><span
                      ...
                      <div className="col-12 col-lg-6">
                        <div className="ps-product ps-product--horizontal">
                          ...
                          <div className="ps-product__content">
                            <h5 className="ps-product__title"><a>Disposable Face <span
                              className="hightlight">mask</span> for Unisex</a></h5>
                            <p className="ps-product__desc">Study history up to 30 days Up to 5 users simultaneously
                              Has HEALTH certificate</p>
                            <div className="ps-product__meta"><span
                              className="ps-product__price sale">$8.15</span><span
          ...
          <div className="container">
            <div className="ps-navigation__left">
              <nav className="ps-main-menu">
                <ul className="menu">
                  <li className="has-mega-menu"><a href="#"> <i className="fa fa-bars"/>Products<span
                    className="sub-toggle"><i className="fa fa-chevron-down"/></span></a>
                      ...
                      <div className="container">
                        ...
                        <div className="ps-branch">
                          ...
                          <div className="ps-branch__box">
                            <div className="ps-branch__item"><a href="#"><img src="img/branch/brand-1.jpg" alt="alt"/></a>
                            </div>
                            <div className="ps-branch__item"><a href="#"><img src="img/branch/brand-2.jpg" alt="alt"/></a>
                            </div>
                            <div className="ps-branch__item"><a href="#"><img src="img/branch/brand-3.jpg" alt="alt"/></a>
                            </div>
                            <div className="ps-branch__item"><a href="#"><img src="img/branch/brand-4.jpg" alt="alt"/></a>
                            </div>
                            <div className="ps-branch__item"><a href="#"><img src="img/branch/brand-5.jpg" alt="alt"/></a>
                            </div>
                            <div className="ps-branch__item"><a href="#"><img src="img/branch/brand-6.jpg" alt="alt"/></a>
                            </div>
                            <div className="ps-branch__item"><a href="#"><img src="img/branch/brand-7.jpg" alt="alt"/></a>
                            </div>
                            <div className="ps-branch__item"><a href="#"><img src="img/branch/brand-8.jpg" alt="alt"/></a>
                            </div>
                            <div className="ps-branch__item"><a href="#"><img src="img/branch/brand-9.jpg" alt="alt"/></a>
                            </div>
                            <div className="ps-branch__item"><a href="#"><img src="img/branch/brand-10.jpg"
                                                                              alt="alt"/></a></div>
                          </div>
                        </div>
                      </div>
                  ...
                  <li className="has-mega-menu"><a href="#"> Home Medical Supplies<span className="sub-toggle"><i
                        ...
                        <div className="mega-menu__row">
                          ...
                          <div className="mega-menu__column col-12 col-sm-5 col-md-6">
                            <div className="ps-promo">
                              <div className="ps-promo__item"><img className="ps-promo__banner"
                            ...
                            <div className="mega-menu__product">
                              ...
                              <div className="ps-product ps-product--standard">
                                <div className="ps-product__thumbnail"><a className="ps-product__image"
                                                                          href="product1.html">
                                  <figure><img src="img/products/039.jpg" alt="alt"/><img src="img/products/048.jpg"
                                                                                          alt="alt"/>
                                  </figure>
                                </a>
                                  <div className="ps-product__actions">
                                    ...
                                    <div className="ps-product__item rotate" data-toggle="tooltip"
                                         data-placement="left" title="Add to compare"><a href="#" data-toggle="modal"
                                ...
                                <div className="ps-product__content">
                                  <h5 className="ps-product__title"><a href="product1.html">Generic Stethoscope
                                    Hearing Heartbeat Tool</a></h5>
                                  <div className="ps-product__meta"><span
                                  ...
                                  <div className="ps-product__actions ps-product__group-mobile">
                                    <div className="ps-product__quantity">
                                      <div className="def-number-input number-input safari_only">
                                        <button className="minus"
                                          ...
                                          <i className="icon-minus"/></button>
                                        <input className="quantity" min={0} name="quantity" defaultValue={1}
                                               type="number"/>
                                    ...
                                    <div className="ps-product__item cart" data-toggle="tooltip" data-placement="left"
                                         title="Add to cart"><a href="#"><i className="fa fa-shopping-basket"/></a>
                                    </div>
                                    <div className="ps-product__item" data-toggle="tooltip" data-placement="left"
                                         title="Wishlist"><a href="wishlist.html"><i className="fa fa-heart-o"/></a>
                                    </div>
                                    <div className="ps-product__item rotate" data-toggle="tooltip"
                  ...
                  <li className="has-mega-menu"><a href="#"> Homepages<span className="sub-toggle"><i
                    className="fa fa-chevron-down"/></span></a>
                    <div className="mega-menu">
                      <div className="container">
                        <div className="mega-menu__widget">
                          <ul className="sub-menu--image">
                            <li><a href="index-2.html"><img src="img/promotion/1.jpg" alt="alt"/></a>
                              <h3 className="image-title">Home 1</h3>
                            </li>
                            <li><a href="home2.html"><img src="img/promotion/2.jpg" alt="alt"/></a>
                              <h3 className="image-title">Home 2</h3>
                            </li>
                            <li><a href="home3.html"><img src="img/promotion/3.jpg" alt="alt"/></a>
                              <h3 className="image-title">Home 3</h3>
                            </li>
                            <li><a href="home4.html"><img src="img/promotion/4.jpg" alt="alt"/></a>
                              <h3 className="image-title">Home 4</h3>
                            </li>
                            <li><a href="home5.html"><img src="img/promotion/5.jpg" alt="alt"/></a>
                              <h3 className="image-title">Home 5</h3>
                            </li>
                            <li><a href="home6.html"><img src="img/promotion/6.jpg" alt="alt"/></a>
                              <h3 className="image-title">Home 6 Masks</h3>
                            </li>
                            <li><a href="home7.html"><img src="img/promotion/7.jpg" alt="alt"/></a>
                              <h3 className="image-title">Home 7 One product</h3>
                            </li>
                            <li><a href="home8.html"><img src="img/promotion/8.jpg" alt="alt"/></a>
                              <h3 className="image-title">Home 8</h3><span className="has-badge">New</span>
                            </li>
                            <li><a href="home9.html"><img src="img/promotion/9.jpg" alt="alt"/></a>
                              <h3 className="image-title">Home 9</h3><span className="has-badge">New</span>
                            </li>
                            <li><a href="home10.html"><img src="img/promotion/10.jpg" alt="alt"/></a>
                              <h3 className="image-title">Home 10</h3><span className="has-badge">New</span>
                            </li>
                            <li><a href="home11.html"><img src="img/promotion/11.jpg" alt="alt"/></a>
                              <h3 className="image-title">Home 11</h3><span className="has-badge">New</span>
                            </li>
                            <li><a href="home12.html"><img src="img/promotion/12.jpg" alt="alt"/></a>
                              <h3 className="image-title">Home 12</h3><span className="has-badge">New</span>
                            </li>
                            <li><a href="home13.html"><img src="img/promotion/13.jpg" alt="alt"/></a>
                              <h3 className="image-title">Home 13</h3><span className="has-badge">New</span>
                            </li>
                            <li><a href="home14.html"><img src="img/promotion/14.jpg" alt="alt"/></a>
                              <h3 className="image-title">Home 14</h3><span className="has-badge">New</span>
                            </li>
                            <li><a href="home15.html"><img src="img/promotion/15.jpg" alt="alt"/></a>
                              <h3 className="image-title">Home 15</h3><span className="has-badge">New</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                  ...
                  <li className="has-mega-menu"><a href="category-list.html">Shop</a></li>
                  <li className="has-mega-menu"><a href="#"> Pages<span className="sub-toggle"><i
                    className="fa fa-chevron-down"/></span></a>
                    <div className="mega-menu">
                      <div className="container">
                        <div className="mega-menu__row">
                  ...
                  <li className="has-mega-menu"><a href="#"> Collection<span className="sub-toggle"><i
                    className="fa fa-chevron-down"/></span></a>
                    <div className="mega-menu">
                      <div className="container">
                        <div className="mega-menu__row">
                              ...
                              <div className="row">
                                <div className="col-12 col-sm-6 col-lg-3">
                                  <div className="ps-product ps-product--standard">
                                    ...
                                    <div className="ps-product__content">
                                      <h5 className="ps-product__title"><a href="product1.html">Somersung Sonic X2000
                                        Pro Black</a></h5>
                                      <div className="ps-product__meta"><span
                                        className="ps-product__price">$299.99</span>
                                      </div>
                                      <div className="ps-product__rating">
                                        <select className="ps-rating" data-read-only="true">
                                          <option value={1}>1</option>
                                      ...
                                      <div className="ps-product__actions ps-product__group-mobile">
                                        ...
                                        <div className="ps-product__cart"><a className="ps-btn ps-btn--warning"
                                                                             href="#" data-toggle="modal"
                                                                             data-target="#popupAddcart">Add to
                                          cart</a></div>
                                        <div className="ps-product__item cart" data-toggle="tooltip"
                                             data-placement="left" title="Add to cart"><a href="#"><i
                                          className="fa fa-shopping-basket"/></a></div>
                                        <div className="ps-product__item" data-toggle="tooltip" data-placement="left"
                                             title="Wishlist"><a href="wishlist.html"><i
                                          className="fa fa-heart-o"/></a></div>
                                        <div className="ps-product__item rotate" data-toggle="tooltip"
                                             data-placement="left" title="Add to compare"><a href="compare.html"><i
                                          className="fa fa-align-left"/></a></div>
                                      </div>
                                ...
                                <div className="col-12 col-sm-6 col-lg-3">
                                  <div className="ps-product ps-product--standard">
                                    ...
                                    <div className="ps-product__content">
                                      <h5 className="ps-product__title"><a href="product1.html">Digital Thermometer
                                        X30-Pro</a></h5>
                                      <div className="ps-product__meta"><span
                                ...
                                <div className="col-12 col-sm-6 col-lg-3">
                                  <div className="ps-product ps-product--standard">
                                    ...
                                    <div className="ps-product__content">
                                      <h5 className="ps-product__title"><a href="product1.html">Oxygen concentrator
                                        model KTS-5000</a></h5>
                                      <div className="ps-product__meta"><span
                                        className="ps-product__price">$53.99</span>
                                      </div>
                                      <div className="ps-product__rating">
                                        <select className="ps-rating" data-read-only="true">
                                          <option value={1}>1</option>
                                ...
                                <div className="col-12 col-sm-6 col-lg-3">
                                  <div className="ps-product ps-product--standard">
                                    ...
                                    <div className="ps-product__content">
                                      <h5 className="ps-product__title"><a href="product1.html">Blue Hot Water Bottle,
                                        2 Quart Capacity</a></h5>
                                      <div className="ps-product__meta"><span
                                        className="ps-product__price sale">$38.39</span><span
                                        className="ps-product__del">$14.52 - $15.52</span>
                                      </div>
                                      <div className="ps-product__rating">
                                        <select className="ps-rating" data-read-only="true">
                                          <option value={1}>1</option>
                  ...
                  <li className="has-mega-menu"><a href="blog-sidebar1.html">Blog</a></li>
                  <li className="has-mega-menu"><a href="contact-us.html">Contact</a></li>
                </ul>
              </nav>
            </div>
            <div className="ps-navigation__right">Need help? <strong>0020 500 - MYMEDI - 000</strong></div>
          </div>
        </div>
      </header>
      ...
      <header className="ps-header ps-header--1 ps-header--mobile">
        ...
        <div className="ps-header__middle">
          <div className="container">
            <div className="ps-logo"><a href="index-2.html"> <img src="img/mobile-logo.png" alt=""/></a></div>
            <div className="ps-header__right">
              <ul className="ps-header__icons">
                <li><a className="ps-header__item open-search" href="#"><i className="fa fa-search"/></a></li>
              </ul>
            </div>
          </div>
        </div>
