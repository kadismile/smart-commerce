      ...
      <div className="ps-menu--slidebar">
        <div className="ps-menu__content">
          <ul className="menu--mobile">
              ...
              <ul className="sub-menu">
                <li>
                  ...
                  <ul className="sub-menu">
                    ...
                    <li>
                      <a href="category-list.html">Gypsum foundations</a>
                    </li>
                    <li>
                      <a href="category-list.html">Patches and tapes</a>
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul className="sub-menu">
                    <li>
                      <a href="category-list.html">Disposable products</a>
                    </li>
                    <li>
                ...
                <li>
                  ...
                  <ul className="sub-menu">
                    ...
                    <li>
                      <a href="category-list.html">Diagnostic tests</a>
                    </li>
                  </ul>
                </li>
              </ul>
            ...
            <li className="menu-item-has-children">
              <a href="#/">Home Medical Supplies</a>
              <span className="sub-toggle">
                <i className="fa fa-chevron-down" />
              </span>
              <ul className="sub-menu">
                ...
                <li>
                  <a href="category-list.html">Accessories Tools</a>
                </li>
                <li>
                  <a href="category-list.html">Bandages</a>
                </li>
            ...
            <li className="menu-item-has-children">
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <a href="home8.html">Home 08</a>
                </li>
                <li>
                  <a href="home9.html">Home 09</a>
                </li>
                <li>
                  <a href="home10.html">Home 10</a>
                </li>
                <li>
                  <a href="home11.html">Home 11</a>
                </li>
                <li>
                  <a href="home12.html">Home 12</a>
                </li>
                <li>
                  <a href="home13.html">Home 13</a>
                </li>
                <li>
                  <a href="home14.html">Home 14</a>
                </li>
                <li>
                  <a href="home15.html">Home 15</a>
                </li>
              </ul>
            </li>
            <li className="menu-item-has-children">
              ...
              <ul className="sub-menu">
                <li>
                  ...
                  <ul className="sub-menu">
                    ...
                    <li>
                      <a href="category-grid-detail.html">Grid with details</a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="category-grid-separate.html">Grid separate</a>
                    </li>
                    <li>
