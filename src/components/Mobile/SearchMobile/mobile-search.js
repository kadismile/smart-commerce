            ...
            <div className="ps-product ps-product--horizontal">
              ...
              <div className="ps-product__content">
                <h5 className="ps-product__title">
                  <a href="#/">
                    3-layer <span className="hightlight">mask</span> with an
          ...
          <div className="ps-search__item">
            <div className="ps-product ps-product--horizontal">
              ...
              <div className="ps-product__content">
                ...
                <div className="ps-product__meta">
                  <span className="ps-product__price sale">$14.99</span>
          ...
          <div className="ps-search__item">
            <div className="ps-product ps-product--horizontal">
              ...
              <div className="ps-product__content">
                <h5 className="ps-product__title">
                  <a href="#/">
                    Disposable Face <span className="hightlight">mask</span> for
                    Unisex
                  </a>
                </h5>
                <p className="ps-product__desc">
                ...
                <div className="ps-product__meta">
                  <span className="ps-product__price sale">$8.15</span>
